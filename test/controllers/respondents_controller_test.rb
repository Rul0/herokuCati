...
class RespondentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create respondent" do
    assert_difference('Respondent.count') do
      post respondents_url, params: { respondent: { name: @respondent.name, phone: @respondent.phone } }
    end
  ...
  test "should update respondent" do
    patch respondent_url(@respondent), params: { respondent: { name: @respondent.name, phone: @respondent.phone } }
